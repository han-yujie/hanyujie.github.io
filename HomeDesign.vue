...
.common-header h3 { 
  font-size: 2.5rem; font-weight: 900; margin: 15px 0; line-height: 1.4;
...
.purple-gradient-bg { position: absolute; width: 100%; height: 100%; background: radial-gradient(circle at center, rgba(139, 92, 246, 0.4) 0%, rgba(139, 92, 246, 0.05) 50%, transparent 70%); filter: blur(20px); }
.hero-img { width: 80%; z-index: 1; animation: float 6s ease-in-out infinite; border-radius: 20px; }
@keyframes float { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-20px); } }

/* === 简历入口板块 (优化对齐与色调) === */
.resume-bar { 
  margin-bottom: 60px; padding: 60px 50px; 
  background-color: var(--vp-c-bg-soft); 
  border: 1px solid var(--vp-c-divider);
...
.work-card, .aigc-card { position: relative; aspect-ratio: 4/3; text-decoration: none !important; }
...
.mask { position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); opacity: 0.6; }
.info, .aigc-info { position: absolute; bottom: 0; padding: 24px; width: 100%; z-index: 2; }
.white-text { color: white !important; margin: 5px 0 0; }
.cat { font-size: 12px; color: #d8b4fe; font-weight: 700; letter-spacing: 1px; }
...
.meta-tag { background: var(--vp-c-bg); padding: 6px 12px; border-radius: 8px; border: 1px solid var(--vp-c-divider); font-size: 0.85rem; margin-right: 10px; display: inline-flex; align-items: center; gap: 5px; }

.tool-card { padding: 30px; text-align: center; display: flex; flex-direction: column; align-items: center; }
.tool-icon { font-size: 2rem; margin-bottom: 15px; }
.btn-download { background: #8B5CF6; color: white !important; width: 100%; padding: 10px 0; border-radius: 8px; text-decoration: none; margin-top: 15px; font-weight: 600; }

/* === 联系我 (修复排版) === */
.contact-card { display: flex; justify-content: space-between; align-items: center; padding: 60px 50px; gap: 40px; }
.contact-left { flex: 1; }
...
.contact-item { display: flex; align-items: center; gap: 10px; padding: 15px 20px; background: var(--vp-c-bg); border: 1px solid var(--vp-c-divider); border-radius: 12px; text-decoration: none !important; color: var(--vp-c-text-1); transition: all 0.2s; }
.contact-item:hover { border-color: #8B5CF6; transform: translateX(5px); }
.c-icon { width: 24px; height: 24px; flex-shrink: 0; }
:deep(.c-icon svg) { width: 100%; height: 100%; }

/* === 回到顶部 & 弹窗 === */
.back-to-top { position: fixed; bottom: 40px; right: 40px; width: 50px; height: 50px; border-radius: 50%; background: #8B5CF6; color: white; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 15px rgba(139, 92, 246, 0.4); z-index: 100; transition: 0.3s; }
.modal-overlay { position: fixed; inset: 0; background: rgba(0, 0, 0, 0.6); backdrop-filter: blur(5px); display: flex; align-items: center; justify-content: center; z-index: 999; }
.modal-content { background: var(--vp-c-bg); padding: 30px; border-radius: 20px; text-align: center; position: relative; }
.modal-img { max-width: 250px; border-radius: 12px; }
...
/* =================================================================
   📱 移动端完美适配 (Mobile Version)
   ================================================================= */
@media (max-width: 768px) {
  .home-container { padding: 0 16px 60px !important; }
  .section-container { margin-top: 50px !important; }

  /* Hero 缩小 */
  .hero-section { flex-direction: column !important; text-align: center !important; padding-top: 20px !important; min-height: auto !important; }
  ...
  .resume-content { flex-direction: column !important; text-align: center !important; gap: 30px !important; }
  ...
  .btn-resume-cta { width: 100% !important; justify-content: center !important; }

  /* 板块标题缩小 */
  .common-header h3 { font-size: 1.6rem !important; padding: 0 !important; }
  ...
  /* 联系我板块移动端修复 */
  .contact-card { flex-direction: column !important; padding: 40px 20px !important; gap: 30px !important; }
  .contact-left h3 { font-size: 1.6rem !important; }
  .contact-grid { grid-template-columns: 1fr !important; width: 100% !important; }
  .contact-item { width: 100% !important; padding: 12px 15px !important; }
