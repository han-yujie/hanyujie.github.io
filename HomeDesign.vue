...
/* =================================================================
   📱 移动端强制适配 (Mobile Force Fix) - 使用 !important 覆盖所有默认样式
   ================================================================= */
@media (max-width: 768px) {
  /* 1. 全局容器：减少内边距 */
  .home-container { padding: 0 16px 80px !important; }
  .section-container { margin-top: 60px !important; }

  /* 2. Hero 区域：字体强制缩小 */
  .hero-section { flex-direction: column !important; text-align: center !important; padding-top: 20px !important; margin-bottom: 40px !important; min-height: auto !important; }
  .hero-title { font-size: 2.2rem !important; margin-bottom: 15px !important; line-height: 1.2 !important; } /* 缩小大标题 */
  .hero-desc { font-size: 1rem !important; margin-bottom: 25px !important; padding: 0 10px !important; }
  .hero-right { width: 100% !important; height: 300px !important; margin-top: 30px !important; }

  /* 3. 简历板块：【核心修复】强制竖排、减小 Padding、缩小字号 */
  .resume-bar { 
    padding: 30px 20px !important; /* 内边距大幅减小 */
  ...
  .resume-intro h3 { font-size: 1.6rem !important; } /* 名字缩小 */
  .resume-intro p { font-size: 0.9rem !important; }
  ...
  .stat-val { font-size: 2rem !important; } /* 数字大小适中 */
  .stat-lbl { font-size: 0.8rem !important; }

  /* 4. 通用标题：强制缩小 */
  .common-header h3, .aigc-header h3 { font-size: 1.8rem !important; margin: 10px 0 !important; }
  .common-header p, .aigc-header p { font-size: 1rem !important; padding: 0 20px !important; }
  ...
  .blog-main h4 { font-size: 1.3rem !important; } /* 博客标题缩小 */
  ...
  .contact-left, .contact-right { width: 100% !important; max-width: 100% !important; }
  .contact-grid { grid-template-columns: 1fr !important; gap: 12px !important; } /* 单列 */
